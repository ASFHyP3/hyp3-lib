...
def test_get_orbit_url_esa():
    orbit_url = hyp3lib.orbits.get_orbit_url(_GRANULE, provider='ESA')
    ...
    orbit_url = hyp3lib.orbits.get_orbit_url(_GRANULE, orbit_type='aux_resorb', provider='ESA')
...
def test_get_orbit_url_asf():
    orbit_url = hyp3lib.orbits.get_orbit_url(_GRANULE, provider='ASF')
