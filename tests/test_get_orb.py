...
import hyp3lib.sentinel1.orbits

_GRANULE = 'S1A_IW_SLC__1SSV_20150621T120220_20150621T120232_006471_008934_72D8'


def test_download_sentinel_orbit_file_esa():
    orbit_file, provider = hyp3lib.sentinel1.orbits.download_orbit_file(_GRANULE, providers=('ESA',))
...
def test_get_orbit_url_esa():
    orbit_url = hyp3lib.sentinel1.orbits.get_orbit_url(_GRANULE, provider='ESA')
    ...
    orbit_url = hyp3lib.sentinel1.orbits.get_orbit_url(_GRANULE, orbit_type='aux_resorb', provider='ESA')
...
def test_get_orbit_url_asf():
    orbit_url = hyp3lib.sentinel1.orbits.get_orbit_url(_GRANULE, provider='ASF')
